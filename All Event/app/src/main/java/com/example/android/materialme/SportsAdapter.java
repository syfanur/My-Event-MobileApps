...
class SportsAdapter extends RecyclerView.Adapter<SportsAdapter.ViewHolder>  {
    ...
    class ViewHolder extends RecyclerView.ViewHolder
        ...
        ViewHolder(View itemView) {
            ...
            mTicketText = itemView.findViewById(R.id.Ticket);
            mJenisText = itemView.findViewById(R.id.Genre);
        ...
        void bindTo(Sport currentSport){
            mJudulText.setText(currentSport.getJudul());
            mTicketText.setText(currentSport.getTicket());
            mJenisText.setText(currentSport.getJenis());
