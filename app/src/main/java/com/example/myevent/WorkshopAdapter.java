...
class WorkshopAdapter extends RecyclerView.Adapter<WorkshopAdapter.ViewHolder>  {

    // Member variables.
    private ArrayList<Workshop> mMusicData;
     ...
     */
    WorkshopAdapter(Context context, ArrayList<Workshop> sportsData) {
     ...
     */
    @Override
    public WorkshopAdapter.ViewHolder onCreateViewHolder(
     ...
     */
    @Override
    public void onBindViewHolder(WorkshopAdapter.ViewHolder holder,
                                 int position) {
        // Get current sport.
        Workshop currentMusic = mMusicData.get(position);
    ...
    class ViewHolder extends RecyclerView.ViewHolder
        ...
        ViewHolder(View itemView) {
            ...
            tempat = itemView.findViewById(R.id.kategori);
            poster = itemView.findViewById(R.id.poster);
            tanggal = itemView.findViewById(R.id.alamat);
            tiket = itemView.findViewById(R.id.status);

            // Set the OnClickListener to the entire view.
            itemView.setOnClickListener(this);
        }

        void bindTo(Workshop currentMusik){
            // Populate the textviews with data.
        ...
        public void onClick(View view) {
            Workshop currentMusik = mMusicData.get(getAdapterPosition());
