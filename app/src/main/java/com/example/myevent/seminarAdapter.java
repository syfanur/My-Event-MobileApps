...
class seminarAdapter extends RecyclerView.Adapter<seminarAdapter.ViewHolder>  {

    // Member variables.
    private ArrayList<seminar> mMusicData;
     ...
     */
    seminarAdapter(Context context, ArrayList<seminar> sportsData) {
     ...
     */
    @Override
    public seminarAdapter.ViewHolder onCreateViewHolder(
     ...
     */
    @Override
    public void onBindViewHolder(seminarAdapter.ViewHolder holder,
                                 int position) {
        // Get current sport.
        seminar currentMusic = mMusicData.get(position);
    ...
    class ViewHolder extends RecyclerView.ViewHolder
        ...
        void bindTo(seminar currentMusik){
            // Populate the textviews with data.
        ...
        public void onClick(View view) {
            seminar currentMusik = mMusicData.get(getAdapterPosition());
